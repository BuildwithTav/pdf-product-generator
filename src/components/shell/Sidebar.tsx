...
import { FileText, Plus, Sparkles, BrainCircuit } from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-screen w-64 shrink-0 flex-col border-r border-app-border bg-app-surface">
